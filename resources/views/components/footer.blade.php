        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
            ...
            <div class="flex flex-col gap-6">
                ...
                <ul class="space-y-4 text-[11px] font-mono uppercase tracking-widest font-bold">
                    ...
                    <li><a href="{{ route('quienes-somos') }}" class="hover:underline underline-offset-4 transition-colors">Equipo</a></li>
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="space-y-4 text-[10px] font-mono text-[#706f6c] leading-tight">
                    ...
                    @if(config('corporate.linkedin'))
                    <div class="pt-4 mt-4 border-t border-brand-dark/5">
                        <a href="{{ config('corporate.linkedin') }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 group">
                            <svg class="w-4 h-4 fill-[#706f6c] group-hover:fill-brand-dark transition-colors" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                            <span class="font-bold uppercase group-hover:underline underline-offset-2">LinkedIn</span>
                        </a>
                    </div>
                    @endif
                </div>
